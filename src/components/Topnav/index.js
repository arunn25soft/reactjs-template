        ...
        return (
            ...
            <nav className="navbar navbar-static-top">
                ...
                <div className="navbar-custom-menu f-right">
                    <div className="upgrade-button m-r-10">
                        <a href="https://themeforest.net/item/able-pro-responsive-bootstrap-4-admin-template/19300403?ref=phoenixcoded" className="icon-circle txt-white btn btn-sm btn-warning upgrade-button">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li className="bell-notification">
                                    <a href="javascript:;" className="media">
                                        ...
                                        <div className="media-body"><span className="block">Lisa sent you a mail</span><span className="text-muted block-time">2min ago</span></div></a>
                                    </li>
                                    <li className="bell-notification">
                                        <a href="javascript:;" className="media">
                                            <span className="media-left media-icon">
                                            ...
                                            <div className="media-body"><span className="block">Server Not Working</span><span className="text-muted block-time">20min ago</span></div></a>
                                        </li>
                                        <li className="bell-notification">
                                ...
                                <li className="pc-rheader-submenu">
                                    {/* <a href="#!" className="drop icon-circle" onlick="javascript:toggleFullScreen()">
                                ...
                                <li className="dropdown">
                                    ...
                                    <ul className="dropdown-menu settings-menu">
                                        ...
                                        <li><a href="message.html"><i className="icon-envelope-open"></i> My Messages</a></li>
                                        <li className="p-0">
                                            <div className="dropdown-divider m-0"></div>
                                        </li>
                                        <li><a href="lock-screen.html"><i className="icon-lock"></i> Lock Screen</a></li>
