   ...
   <div className="container-fluid">
    ...
    <div className="row m-b-30 dashboard-header">
                <div className="col-lg-3 col-sm-6">
                    <div className="dashboard-primary bg-primary">
                        <div className="sales-primary">
                            <i className="icon-bubbles"></i>
                            <div className="f-right">
                                <h2 className="counter">4500</h2>
                                <span>Total Sales</span>
                            </div>
                        </div>
                        <div className="bg-dark-primary">
                            <p className="week-sales">Total SALES</p>
                            <p className="total-sales">432</p>
                        </div>
                    </div>
                </div>
                <div className="col-lg-3 col-sm-6">
                    <div className="bg-success dashboard-success">
                        ...
                        <div className="bg-dark-success">
                            <p className="week-sales">LAST WEEK'S SALES</p>
                            <p className="total-sales ">432</p>
                        </div>
                    </div>
                </div>
                <div className="col-lg-3 col-sm-6">
                    <div className="bg-warning dasboard-warning">
                        <div className="sales-warning">
                            <i className="icon-basket-loaded"></i>
                            <div className="f-right">
                                <h2 className="counter">1085</h2>
                                <span>New Orders</span>
                            </div>
                        </div>
                        <div className="bg-dark-warning">
                            <p className="week-sales">LAST WEEK'S SALES</p>
                            <p className="total-sales">84</p>
                        </div>
                    </div>
                </div> 
                <div className="col-lg-3 col-sm-6">
                    <div className="col-sm-12 card dashboard-product">
                        <span>Products</span>
                        <h2 className="dashboard-total-products counter">4500</h2>
                        <span className="label label-warning">Orders</span>New Orders
                ...
                <div className="col-lg-3 col-sm-6">
                    <div className="col-sm-12 card dashboard-product">
                        <span>Products</span>
                        <h2 className="dashboard-total-products counter">37,500</h2>
                        <span className="label label-primary">Sales</span>Last Week Sales
            ...
            <div className="row">
                <div className="col-lg-9 col-md-12">
                    ...
                    <div className="card-block">
                        <div className="row">
                            <div className="col-sm-3 col-xs-6 income-per-day">
                                <p>Today</p>
                                $
            ...
            <div className="col-lg-3 col-md-6">
                <div className="card">
                    <div className="bg-danger dashboard-resource">
                        <div className="card-block">
                            <h5 className="counter">20.85</h5>%
                            <h5 className="resource-used">Resource Used</h5>
                        </div>
                        <div className="card-block">
        ...
        <div className="row">
            <div className="col-lg-4 col-md-12 grid-item">
                <div className="card">
                    <div className="card-header">
                        <h5 className="card-header-text">Recent Orders</h5>
                        <span className="m-t-10 text-capitalize d-block">Last 24 Hour Orders</span>
                    </div>
                    <div className="card-block">
                            ...
                            <table className="table m-b-0">
                                <thead>
                                    <tr className="text-uppercase">
                                        <th className="p-t-0">ID</th>
                                        <th className="p-t-0">Item Name</th>
                                        <th className="p-t-0">Price</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
            ...
            <div className="col-lg-8 col-md-12 grid-item">
                <div className="card">
                    <div className="row">
                        <div className="col-lg-7 p-r-0 txt-white climacon-left">
                            <div className="card-block bg-primary">
                                <div className="m-b-5">
                                    <h4 className="dashboard-city">California, USA</h4>
                                    <h5 className="city-cloud">Hot &amp; Sunny</h5>
                                </div>
                                <div>
                                    <h6 className="cloud-date">Yesterday, 12th October 2015</h6>
                                    <div className="cloud-speed">
                                        <i className="icofont icofont-social-cloudapp"></i>
                                ...
                                <ul className="weather-temp">
                                    <li>
                                        <h6 className="txt-white">14:00</h6>
                                        <svg
                                        version="1.1"
                                        id="cloudLightning2"
                                ...
                                <li>
                                    <h6 className="txt-white">22:00</h6>
                                    <svg
                                    version="1.1"
                                    id="cloudDrizzleAlt"
                            ...
                            <li>
                                <h6 className="txt-white">17:00</h6>
                                <svg
                                version="1.1"
                                id="cloudRainAlt"
                        ...
                        <li>
                            <h6 className="txt-white">16:00</h6>
                        ...
                        <li>
                            <h6 className="txt-white">18:00</h6>
                            <svg
                            version="1.1"
                            id="cloudSnowSunAlt"
        ...
        <div className="col-lg-5 p-l-0 climacon-right">
            <div className="p-10">

                <div className="table-responsive">

                    <table className="table weather-table m-t-15">
                        <tbody>
                            <tr className="svg-icon">
                                <td>Sunday</td>
                                <td><svg
                                    version="1.1"
                                    id="cloudDrizzleSun1"
                ...
                <div className="table-responsive">
                    <table className="table m-b-0 photo-table">
                        ...
                        <tbody>
                            <tr>
                                <th>
                                    <img className="img-fluid img-circle" src="assets/images/avatar-2.png" alt="User" />
                                </th>
                                <td>Appestia Project
                                    <p><i className="icofont icofont-clock-time"></i>Created 14.9.2016</p>
                                </td>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <img className="img-fluid img-circle" src="assets/images/avatar-4.png" alt="User" />
                                </th>
                                <td>Contract with belife Company
                                    <p><i className="icofont icofont-clock-time"></i>Created 20.10.2016</p>
                                </td>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <img className="img-fluid img-circle" src="assets/images/avatar-1.png" alt="User" />
                                </th>
                            ...
                            <tr>
                                <th>
                                    <img className="img-fluid img-circle" src="assets/images/avatar-3.png" alt="User" />
                                </th>
                                <td>Contract with belife Company
                                    <p><i className="icofont icofont-clock-time"></i>Created 20.10.2016</p>
                                </td>
    ...
    <div className="col-xl-4 col-lg-12">
        <div className="card">
            <div className="user-block-2">
                <img className="img-fluid" src="assets/images/widget/user-1.png" alt="user-header" />
            ...
            <div className="card-block">
                <div className="user-block-2-activities">
                    <div className="user-block-2-active">
                        <i className="icofont icofont-clock-time"></i> Recent Activities
                        <label className="label label-primary">480</label>
                    </div>
                </div>
                <div className="user-block-2-activities">
                    <div className="user-block-2-active">
                        <i className="icofont icofont-users"></i> Current Employees
                ...
                <div className="user-block-2-activities">
                    <div className="user-block-2-active">
                        <i className="icofont icofont-ui-user"></i> Following
                        <label className="label label-primary">485</label>
                    </div>

                </div>
                <div className="user-block-2-activities">
                    <div className="user-block-2-active">
                        <i className="icofont icofont-picture"></i> Pictures
...
<div className="fixed-button">
    <a href="https://themeforest.net/item/able-pro-responsive-bootstrap-4-admin-template/19300403?ref=phoenixcoded" className="btn btn-md btn-primary">
      <i className="fa fa-shopping-cart" aria-hidden="true"></i> Upgrade To Pro
  </a>
</div>
</div>
      )
